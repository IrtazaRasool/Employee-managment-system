...
const CompleteTask = () => {
  return (
    <div className='h-full  flex-shrink-0 w-[300px] bg-blue-400 rounded-xl overflow-hidden'>
    ...
    <div className='flex justify-around my-12 '>
        <button className='w-5/6 h-10 bg-blue-300 rounded-sm px-2 overflow-hidden'>Completed</button>
    </div>
</div>
  )
}
